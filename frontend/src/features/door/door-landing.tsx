 ...
 * gets you), then a big CTA and the footer close it out. The Pack's own dark neutral palette,
 * thin agency-grid guide lines, accent used sparingly.
 */
...
// The Pack is a submission to the Global AI Hackathon Series with Qwen Cloud. The footer carries
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="relative z-10">
        ...
        <section className="cv-auto relative overflow-hidden border-t border-border-subtle">
          ...
          <Reveal delay={0.12}>
            <div className="relative flex items-end justify-center pb-2">
              <div
                aria-hidden
                className="pointer-events-none absolute bottom-0 left-1/2 h-[300px] w-[300px] -translate-x-1/2 rounded-full opacity-20 blur-3xl"
        ...
        <footer className="cv-auto border-t border-border-subtle">
          {/* The six submission deliverables. Filled slots link out; empty ones show "add link". */}
          <Reveal>
            <div className="mx-auto grid max-w-6xl grid-cols-1 gap-px bg-border-subtle sm:grid-cols-2 md:grid-cols-3">
                ...
                href ? (
                  ...
                  >
                    <span className="flex items-center gap-3 text-[14px] font-medium text-text">
                      ...
                      {label}
                      {note && <span className="text-[11px] font-normal text-text-faint">· {note}</span>}
                    </span>
                  ...
                  <div key={label} className="flex items-center justify-between bg-canvas px-6 py-6">
                    <span className="flex items-center gap-3 text-[14px] font-medium text-text-faint">
                      <Icon size={18} className="text-text-faint" />
                      {label}
                      {note && <span className="text-[11px] font-normal">· {note}</span>}
                    </span>
                    <span className="text-[10px] font-semibold uppercase tracking-[0.18em] text-accent/80">Add link</span>
                  </div>
                ),
              )}
            </div>
            ...
            <Reveal>
              <div className="mx-auto grid max-w-6xl grid-cols-2 gap-10 px-6 py-16 md:grid-cols-4">
                <div className="col-span-2">
                  ...
                  <p className="mt-3 max-w-sm text-[13px] leading-relaxed text-text-faint">
          ...
          <div className="border-t border-border-subtle">
            <div className="mx-auto flex max-w-6xl flex-col gap-1 px-6 py-6 text-[12px] text-text-faint md:flex-row md:items-center md:justify-between">
