...
several. On a **deep** hunt you run on the stronger tier with **thinking ON** — read the full
pages and reason before you extract. On brief/standard hunts you run fast on flash. Either way:
ground truth with sources, never a guess.
